...
type Apis struct {
	...
	GetProductAttrGroups string `default:"/product/ags"`
	GetProduct           string `default:"/product/:id"`
	GetProducts          string `default:"/products"`
	GetProductsEvals     string `default:"/products/evals"`
