...
type User struct {
	...
	RefreshToken null.Bytes `boil:"refresh_token" json:"refresh_token,omitempty" toml:"refresh_token" yaml:"refresh_token,omitempty"`
...
var (
	userColumns               = []string{"id", "user1_id", "name", "refresh_token"}
	userColumnsWithoutDefault = []string{"name", "refresh_token"}
	userColumnsWithDefault    = []string{"id", "user1_id"}
...
// User1G pointed to by the foreign key.
func (o *User) User1G(mods ...qm.QueryMod) userQuery {
	return o.User1(boil.GetDB(), mods...)
}

// User1 pointed to by the foreign key.
func (o *User) User1(exec boil.Executor, mods ...qm.QueryMod) userQuery {
...
// User1UsersG retrieves all the user's user via user1_id column.
func (o *User) User1UsersG(mods ...qm.QueryMod) userQuery {
	return o.User1Users(boil.GetDB(), mods...)
}

// User1Users retrieves all the user's user with an executor via user1_id column.
func (o *User) User1Users(exec boil.Executor, mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
		qm.Select("\"a\".*"),
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"a\".\"user1_id\"=?", o.ID),
	)

	query := Users(exec, queryMods...)
	queries.SetFrom(query.Query, "\"user\" as \"a\"")
	return query
}

// LoadUser1 allows an eager lookup of values, cached into the
// loaded structs of the objects.
func (userL) LoadUser1(e boil.Executor, singular bool, maybeUser interface{}) error {
	var slice []*User
	var object *User
...
// LoadUser1Users allows an eager lookup of values, cached into the
// loaded structs of the objects.
func (userL) LoadUser1Users(e boil.Executor, singular bool, maybeUser interface{}) error {
	var slice []*User
	var object *User
	...
	query := fmt.Sprintf(
		"select * from \"user\" where \"user1_id\" in (%s)",
		strmangle.Placeholders(dialect.IndexPlaceholders, count, 1, 1),
	)
	if boil.DebugMode {
		fmt.Fprintf(boil.DebugWriter, "%s\n%v\n", query, args)
	...
	if singular {
		object.R.User1Users = resultSlice
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.User1ID {
				local.R.User1Users = append(local.R.User1Users, foreign)
				break
			}
		}
	}
...
// SetUser1G of the user to the related item.
// Sets o.R.User1 to related.
// Adds o to related.R.User1Users.
// Uses the global database handle.
func (o *User) SetUser1G(insert bool, related *User) error {
	return o.SetUser1(boil.GetDB(), insert, related)
}

// SetUser1P of the user to the related item.
// Sets o.R.User1 to related.
// Adds o to related.R.User1Users.
// Panics on error.
func (o *User) SetUser1P(exec boil.Executor, insert bool, related *User) {
	if err := o.SetUser1(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetUser1GP of the user to the related item.
// Sets o.R.User1 to related.
// Adds o to related.R.User1Users.
// Uses the global database handle and panics on error.
func (o *User) SetUser1GP(insert bool, related *User) {
	if err := o.SetUser1(boil.GetDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetUser1 of the user to the related item.
// Sets o.R.User1 to related.
// Adds o to related.R.User1Users.
func (o *User) SetUser1(exec boil.Executor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &userR{
			User1Users: UserSlice{o},
		}
	} else {
		related.R.User1Users = append(related.R.User1Users, o)
	}

	return nil
}

// AddUser1UsersG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.User1Users.
// Sets related.R.User1 appropriately.
// Uses the global database handle.
func (o *User) AddUser1UsersG(insert bool, related ...*User) error {
	return o.AddUser1Users(boil.GetDB(), insert, related...)
}

// AddUser1UsersP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.User1Users.
// Sets related.R.User1 appropriately.
// Panics on error.
func (o *User) AddUser1UsersP(exec boil.Executor, insert bool, related ...*User) {
	if err := o.AddUser1Users(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddUser1UsersGP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.User1Users.
// Sets related.R.User1 appropriately.
// Uses the global database handle and panics on error.
func (o *User) AddUser1UsersGP(insert bool, related ...*User) {
	if err := o.AddUser1Users(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddUser1Users adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.User1Users.
// Sets related.R.User1 appropriately.
func (o *User) AddUser1Users(exec boil.Executor, insert bool, related ...*User) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.User1Users = append(o.R.User1Users, related...)
	}
